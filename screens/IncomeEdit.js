...
const IncomeEdit = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button mode="contained" onPress={handleUpdate} style={styles.input} buttonColor="#4caf50">
        Güncelle
      </Button>
